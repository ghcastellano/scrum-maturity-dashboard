...
const translations = {
  en: {
    ...
    // Product Management
    pmEpicOverview: 'Epic Overview',
    pmDependencies: 'Dependencies',
    pmLoadEpics: 'Load Epics from Jira',
    pmLoadingEpics: 'Loading epics from Jira...',
    pmMayTakeMinute: 'Fetching epics, children, and dependencies...',
    pmNoEpics: 'No epics found. Click "Load Epics from Jira" to fetch data.',
    pmRefresh: 'Refresh from Jira',
    pmRefreshing: 'Refreshing...',
    pmEpicHealth: 'Epic Health Summary',
    pmTotalEpics: 'Total Epics',
    pmAvgProgress: 'Avg Progress',
    pmTotalStories: 'Total Stories',
    pmStoriesDone: 'Stories Done',
    pmOnTrack: 'On Track',
    pmAtRisk: 'At Risk',
    pmOverdue: 'Overdue',
    pmStalled: 'Stalled',
    pmDone: 'Done',
    pmEmpty: 'Empty',
    pmHealthDistribution: 'Health Distribution',
    pmEpicDetails: 'Epic Details',
    pmProgress: 'Progress',
    pmChildren: 'children',
    pmPoints: 'points',
    pmDueDate: 'Due',
    pmNoDueDate: 'No due date',
    pmInitiatives: 'Initiatives',
    pmNoInitiatives: 'No initiatives found',
    pmDepSummary: 'Dependency Summary',
    pmEpicsWithDeps: 'Epics with Dependencies',
    pmTotalBlocking: 'Blocking Others',
    pmTotalBlockedBy: 'Blocked By Others',
    pmTotalRelated: 'Related Links',
    pmNoDependencies: 'No dependencies found between epics.',
    pmBlocks: 'Blocks',
    pmBlockedBy: 'Blocked By',
    pmRelatesTo: 'Relates To',
    pmFilterAll: 'All',
    pmFilterActive: 'Active',
    pmFilterDone: 'Done',
    pmSortByHealth: 'Sort by Health',
    pmSortByProgress: 'Sort by Progress',
    pmSortByName: 'Sort by Name',
    pmProjectKeys: 'Projects',
    pmCachedData: 'Cached data',
    pmMinutesAgo: 'min ago',
  ...
  'pt-BR': {
    ...
    // Product Management
    pmEpicOverview: 'Visao Geral dos Epicos',
    pmDependencies: 'Dependencias',
    pmLoadEpics: 'Carregar Epicos do Jira',
    pmLoadingEpics: 'Carregando epicos do Jira...',
    pmMayTakeMinute: 'Buscando epicos, historias e dependencias...',
    pmNoEpics: 'Nenhum epico encontrado. Clique em "Carregar Epicos do Jira" para buscar dados.',
    pmRefresh: 'Atualizar do Jira',
    pmRefreshing: 'Atualizando...',
    pmEpicHealth: 'Resumo de Saude dos Epicos',
    pmTotalEpics: 'Total de Epicos',
    pmAvgProgress: 'Progresso Medio',
    pmTotalStories: 'Total de Historias',
    pmStoriesDone: 'Historias Concluidas',
    pmOnTrack: 'No Prazo',
    pmAtRisk: 'Em Risco',
    pmOverdue: 'Atrasado',
    pmStalled: 'Parado',
    pmDone: 'Concluido',
    pmEmpty: 'Vazio',
    pmHealthDistribution: 'Distribuicao de Saude',
    pmEpicDetails: 'Detalhes dos Epicos',
    pmProgress: 'Progresso',
    pmChildren: 'historias',
    pmPoints: 'pontos',
    pmDueDate: 'Prazo',
    pmNoDueDate: 'Sem prazo',
    pmInitiatives: 'Iniciativas',
    pmNoInitiatives: 'Nenhuma iniciativa encontrada',
    pmDepSummary: 'Resumo de Dependencias',
    pmEpicsWithDeps: 'Epicos com Dependencias',
    pmTotalBlocking: 'Bloqueando Outros',
    pmTotalBlockedBy: 'Bloqueado por Outros',
    pmTotalRelated: 'Links Relacionados',
    pmNoDependencies: 'Nenhuma dependencia encontrada entre epicos.',
    pmBlocks: 'Bloqueia',
    pmBlockedBy: 'Bloqueado Por',
    pmRelatesTo: 'Relacionado A',
    pmFilterAll: 'Todos',
    pmFilterActive: 'Ativos',
    pmFilterDone: 'Concluidos',
    pmSortByHealth: 'Ordenar por Saude',
    pmSortByProgress: 'Ordenar por Progresso',
    pmSortByName: 'Ordenar por Nome',
    pmProjectKeys: 'Projetos',
    pmCachedData: 'Dados em cache',
    pmMinutesAgo: 'min atras',
