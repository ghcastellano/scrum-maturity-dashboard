...
const translations = {
  en: {
    ...
    devCycleTimeDesc: 'Average days from creation to resolution by issue type (stories/bugs)',
  ...
  'pt-BR': {
    ...
    devCycleTimeDesc: 'Media de dias da criacao ate a resolucao por tipo de item (stories/bugs)',
